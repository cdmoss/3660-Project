...
if (count($result->errors) > 0) {
    ...
    while ($customer = $result->data->fetch()) {
        ...
        echo "<div class='form-group' style='min-width: 300px; width: 25%; margin-left: 2%;'><label for='cusemail'>Email Address</label><input type='text' class='form-control' name='cusemail' value='" . $customer['email'] . "' /></div>";
